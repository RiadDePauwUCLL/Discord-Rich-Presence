...
while True:
    ...
    if STATUS != LASTSTATUS and STATUS != None: # To prevent spamming Discord, only update when something changes
        ...
        # The big RPC update
        RPC.update(state=STATUS, details="Running " + HYPERVISOR, small_image="fedora", large_image="xpcat", small_text=HYPERVISOR, large_text="gigachad", start=epoch_time, party_size=vmcount)
